...
public class Appearance {
	...
	public Appearance() {
		typeColor = "#7F0091";
		marksColor = "#2A00FF";
		annotationColor = "#646464";
		font = "¡• È";
		size = "5";
	}

	public Appearance(String typeColor, String marksColor,
			String annotationColor, String font, String size) {
	...
	/**
	 * @param marksColor
	 *            the marksColor to set
	 */
	public void setMarksColor(String marksColor) {
		this.marksColor = marksColor;
	}
	...
	public static String changeColor(int r, int g, int b) {
